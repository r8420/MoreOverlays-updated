...
public class OptionGeneric<V>
    ...
    public OptionGeneric(ConfigOptionList list, ConfigSpec.ConfigValue<V> valSpec) {
        super(list, valSpec);
    ...
    public boolean keyReleased(net.minecraft.client.input.KeyEvent event) {
        ...
        try {
            if (this.value.getClazz() == String.class) {
                this.updateValue((V) this.tfConfigEntry.getValue());
            } else if (this.value instanceof ConfigSpec.ConfigValue.IntValue) {
                this.updateValue((V) Integer.valueOf(this.tfConfigEntry.getValue()));
            } else if (this.value instanceof ConfigSpec.ConfigValue.DoubleValue) {
                this.updateValue((V) Double.valueOf(this.tfConfigEntry.getValue()));
            } else if (this.value instanceof ConfigSpec.ConfigValue.BooleanValue) {
