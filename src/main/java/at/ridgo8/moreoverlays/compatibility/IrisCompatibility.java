...
public final class IrisCompatibility {
    ...
    private static final boolean IRIS_ENABLED = ModList.get().isLoaded("iris");
    ...
    /**
     * Assigns the mod's custom pipelines to iris programs when Iris is present.
     */
    public static void assignPipelines() {
        ...
        assignPipeline(RenderTypes.LINE_PIPELINE, "LINES");
        assignPipeline(RenderTypes.TRIANGLE_PIPELINE, "BASIC");
    }
    ...
    private static void assignPipeline(RenderPipeline pipeline, String irisProgramName) {
        try {
            ...
            LOGGER.error("[MoreOverlays Iris Compatibility] Failed to assign pipeline {} to {}.",
                pipeline.getLocation(), irisProgramName, e);
        }
    }
